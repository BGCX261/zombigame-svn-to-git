...
/// CFontManager:: Init
///</summary>
///<param name="RM">Render Manager</param>
...
///<summary>
/// CFontManager:: LoadTTFs
///</summary>
///<param name="pathFile">Ubicación del fichero xml</param>
			...
			for (int i = 0; i < count; ++i)
			{
				...
				if (!exist) 
				{
					...
					if (id==1)
					{
						...
						uint32 l_Id=CreateFont(size, bold, italica, name, _default);
						if(l_Id!=-1)
						{
							m_TTFs[fontId] = l_Id;
...
///<param name="replaceDefault"></param>
///<returns name=""></returns>
uint32 CFontManager::CreateFont (uint32 size, bool bold, bool italica, const std::string& fontName, bool replaceDefault)
{
	...
	HRESULT l_HR=D3DXCreateFont(	m_pD3DDevice, size, 0, weight, 1, italica, DEFAULT_CHARSET,				
									OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE,	
									fontName.c_str(),	&font);	
	if(l_HR!=S_OK)
	{
		LOGGER->AddNewLog(ELL_ERROR, "CreateFont:: no se ha podido añadir la fuente file: %s", fontName.c_str()); 
		return -1;
	}
...
///<summary>
/// CFontManager:: DrawText
///</summary>
///<param name="x"></param>
///<param name="y"></param>
///<param name="color"></param>
///<param name="idFont"></param>
///<param name="format"></param>
///<returns name=""></returns>
...
///<summary>
/// CFontManager:: DrawLiteral
///</summary>
///<param name="x"></param>
///<param name="y"></param>
///<param name="s_lit"></param>
///<returns name=""></returns>
