...
void CRadioBox::Render (CRenderManager *renderManager, CFontManager* fm)
{
...
void CRadioBox::SetCheckButton (const std::string& name, CTexture* on, CTexture* off, CTexture* deactivated )
{
	...
	CCheckButton newCheckButton(CGuiElement::m_uWindowsHeight, CGuiElement::m_uWindowsWidth, heightButton, widthButton, pos, false, "", 0, 0, true, true);
