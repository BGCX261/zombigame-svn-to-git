...
void CCheckButton::Render (CRenderManager *renderManager, CFontManager* fm)
{
	if( CGuiElement::m_bIsVisible)
	{
		...
		if( CGuiElement::m_bIsActive )
		{
			if( m_eState == CBS_ON )
			{
				if (m_pOnTexture)
				{
					renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_pOnTexture);
				}
				else
				{
					renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_OnColor);
				}
			}
			else
			{
				if (m_pOnTexture)
				{
					renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_pOffTexture);
				}
				else
				{
					renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_OffColor);
				}
			}
		}
		else
