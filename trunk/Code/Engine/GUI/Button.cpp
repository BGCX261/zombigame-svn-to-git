...
void CButton::Render	(CRenderManager *renderManager, CFontManager* fm)
{
	if( CGuiElement::m_bIsVisible)
	{
		...
		case BS_NORMAL:
			if (m_pNormalTexture)
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_pNormalTexture);
			}
			else
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_NormalColor);
			}
			break;
		case BS_OVER:
			if (m_pOverTexture)
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_pOverTexture);
			}
			else
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_OverColor);
			}
			break;
		case BS_CLICKED:
			if (m_pClickedTexture)
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_pClickedTexture);
			}
			else
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_ClickedColor);
			}
			break;
		default:
		...
		if( !CGuiElement::m_bIsActive )
		{
			...
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_pDeactivatedTexture);
			}
			else
			{
				renderManager->DrawQuad2D(CGuiElement::m_Position,CGuiElement::m_uWidth,CGuiElement::m_uHeight, CRenderManager::UPPER_LEFT, m_DeactivatedColor);
			}
		}
